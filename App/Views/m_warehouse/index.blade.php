<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{lang('Form.masterwarehouse')}}</h1>
          </div>
          <div class="col-sm-6">
                ...
                <div class="card-header">
                    <div class = "row">
                        ...
                        <div class = "col-6 text-right">
                            <a class = "" href="{{ baseUrl('mwarehouse/add')}}"><i class = "fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        <table id = "tablewarehouse" style="width: 100%;" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed " role="grid">
  ...
  <script>
    ...
    function dataTable(){
      ...
      table.on( 'click', '.role', function () {
          ...
          var data = table.row($tr).data();;
          var id = data['Id'];
          window.location = "{{ baseUrl('mwarehouse/editrole/')}}" + id;
      });
      ...
      table.on( 'click', '.reportrole', function () {
          ...
          var data = table.row($tr).data();;
          var id = data['Id'];
          window.location = "{{ baseUrl('mwarehouse/editreportrole/')}}" + id;
      });
    }
