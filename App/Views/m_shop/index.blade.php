    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                        <table id = "tableshop" style="width: 100%;" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed " role="grid">
  ...
  <script>
    ...
    function dataTable(){
      ...
      table.on( 'click', '.role', function () {
          ...
          var data = table.row($tr).data();;
          var id = data['Id'];
          window.location = "{{ baseUrl('mshop/editrole/')}}" + id;
      });
      ...
      table.on( 'click', '.reportrole', function () {
          ...
          var data = table.row($tr).data();;
          var id = data['Id'];
          window.location = "{{ baseUrl('mshop/editreportrole/')}}" + id;
      });
    }
