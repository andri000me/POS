                    ...
                    <div class="card-header">
                        <div class = "row">
                            ...
                            <div class = "col-6 text-right">
                              <a class = "" href="{{ baseUrl('titemstockdetaildetail')}}"><i class = "fa fa-plus"></i></a>
                          </div>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                              {!! formOpen(baseUrl('titemstockdetail/editsave'))!!}
                              {!! formInput(
                                array(
                                  "id" => "Id",
                                  "type" => "text",
                            ...
                            <div class="required">
                              ...
                              ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <a href="{{ baseUrl('titemstockdetail') }}" value="{{ lang('Form.cancel') }}" class="btn btn-primary">{{ lang('Form.cancel') }}</a>
                                </div>
                              {!! formClose() !!}
                        </div>
                    <!-- /.card-body -->
