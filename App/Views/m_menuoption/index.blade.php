<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                        <table id = "tablemenuoption" style="width: 100%;" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed " role="grid">
  ...
  <script>
    ...
    function dataTable(){
      ...
      loadIndexDataTable("tablemenuoption", 
      "{{ baseUrl('mmenuoption/getAllData')}}", 
      "{{ lang('Form.search')}}", 
      "{{ baseUrl('mmenuoption/delete/')}}",
      columns
      );
