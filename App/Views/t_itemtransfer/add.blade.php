<div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-12">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                            {!! formOpen(baseUrl('titemtransfer/addsave'))!!}
      ...
      <script>
        ...
        $(document).ready(function() {   
            shopModalSet("M_Shop_Id_To", "shopnameto");
            shopModalSetUrl('mshop/getItemTransferShopModal');
          
        });

        // $('#btnShopToModal').on("click", function(){
        //     shopModalSet("M_Shop_Id_To", "shopnameto");
        //     shopModalSetUrl('mshop/getItemTransferShopModal');
        // });
